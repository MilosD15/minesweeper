...
const applauseSound = new Audio('../sounds/applause-sound.mp3');
applauseSound.volume = 0.5;
const explosionSound = new Audio('../sounds/explosion-sound.mp3');
explosionSound.volume = 0.5;
const openMenuSound = new Audio('../sounds/open-menu-sound.mp3');
openMenuSound.volume = 0.5;
// sounds for loading animation (animation at the beginning)
const preExplosionSound = new Audio('../sounds/pre-bomb-explosion-sound.mp3');
preExplosionSound.loop = true;
preExplosionSound.volume = 0.3;
const loaderExplosionSound = new Audio('../sounds/loader-explosion-sound.mp3');
